...
| サービス | 用途 | 状態 |
|---------|------|------|
| Vector | ソフトウェア販売（国内向け） | 未登録 |
| PayPal | クレジットカード決済（国際対応） | 未登録 |

#### Webサイトへの追加予定

1. **購入ページの作成** または **サポートページへの追記**
   - 購入方法の説明
   - 価格表示
   - 各決済サービスへのリンク

2. **対応予定の決済方法**
   - Vector経由（クレジットカード、コンビニ決済等）
   - PayPal（クレジットカード、PayPal残高）
   - 銀行振込（法人向け）
